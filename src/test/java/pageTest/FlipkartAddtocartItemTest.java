...
public class FlipkartAddtocartItemTest extends BaseTest {
	...
	public void FlipkartAddRemoveProductTest() throws IOException, Exception {
		...
		Assert.assertTrue(isEleDisplayed, "Fail: FlipKart Main Menu Element Displayed - " + productData.get("mainMenuItem"));
		...
		Assert.assertTrue(isEleDisplayed, "Fail: FlipKart Sub Menu Item Element Displayed - " + productData.get("subMenuItem"));
		...
		Assert.assertTrue(isEleDisplayed, "Fail: FlipKart Sub Section Element Displayed - " + productData.get("subSectionItem"));
		...
		Assert.assertTrue(isEleDisplayed, "Fail: FlipKart Sort By Option Element Displayed - " + productData.get("sortByOption"));
		...
		prdPage.addToCart(productData.get("productSize"));
		prdPage.removeFromCart(productData.get("productBrand"), productData.get("product"));
	}
}
